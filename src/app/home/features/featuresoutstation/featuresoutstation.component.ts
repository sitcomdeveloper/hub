...
@Component({
  selector: 'app-featuresoutstation',
  templateUrl: './featuresoutstation.component.html',
  styleUrls: ['./featuresoutstation.component.css']
})
export class FeaturesoutstationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // for features
    this.loadScript("assets/www.olacabs.com/webstatic/js/features.js");
    this.loadScript("assets/www.olacabs.com/webstatic/js/send-events.js");
  }

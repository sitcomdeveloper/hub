...
@Component({
  selector: 'app-featurescitytaxi',
  templateUrl: './featurescitytaxi.component.html',
  styleUrls: ['./featurescitytaxi.component.css']
})
export class FeaturescitytaxiComponent implements OnInit {
